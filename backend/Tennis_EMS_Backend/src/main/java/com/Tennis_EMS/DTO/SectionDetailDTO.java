...
public class SectionDetailDTO {
    ...
    public SectionDetailDTO(Integer sectionId, Integer courseId, Integer coachId, String name,
                            String syllabus, LocalDate startDate, LocalDate endDate, Integer maxStudents,
                            String enrollmentMode, String status, Boolean isActive, String courseName,
